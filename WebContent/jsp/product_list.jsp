<%@page import="store.domain.Product"%>
<%@page import="store.service.ProductService"%>
<%@page import="store.service.impl.ProductServiceImpl"%>
<%@page import="store.utils.CookieUtils"%>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach var="p" items="${ PageBean.list }">
				<div class="col-md-2">
					...
					<p><a href="${ pageContext.request.contextPath }/ProductServlet?method=findByPid&pid=${ p.pid }" style='color:green'>${fn:substring(p.pname,0,10) }...</a></p>
			...
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:forEach var="i" begin="1" end="${ PageBean.totalPage }">
					<c:if test="${ PageBean.currPage == i }">
						<li class="active"><a href="${ pageContext.request.contextPath }/ProductServlet?method=findByCid&currPage=${ i }&cid=${ param.cid }">${ i }</a></li>
					</c:if>
					<c:if test="${ PageBean.currPage != i }">
