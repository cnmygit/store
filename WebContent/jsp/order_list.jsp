								...
								<tr class="success">
									<th colspan="5">
										...
										<c:if test="${ order.state == 3 }">
											<a href="${ pageContext.request.contextPath }/OrderServlet?method=confirmOrder&oid=${ order.oid }">确认收货</a>
										</c:if>
			...
			<div style="text-align: center;">
				<ul class="pagination">
					...
					<c:forEach var="i" begin="1" end="${ pageBean.totalPage }" >
						...
						<c:if test="${ pageBean.currPage != i }">
							<li><a href="${ pageContext.request.contextPath }/OrderServlet?method=findByUid&currPage=${ i }">${ i }</a></li>
						</c:if>
					</c:forEach>
